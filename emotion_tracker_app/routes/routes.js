...
router.get('/create-snapshot', authenticateToken, controller.getCreateSnapshotPage);
//router.get('/edit-snapshot', authenticateToken, controller.getEditSnapshotPage);
router.get('/snapshot-summary', authenticateToken, controller.getSummaryPage);
router.get('/insights', authenticateToken, controller.getInsightsPage);
